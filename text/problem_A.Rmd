...
It seems that the LS estimator is not the optimal estimator for this non-Gaussian AR(2) process. This is due to the fact that the estimated variance is much smaller for the LA estimator. 

- bias is a lot smaller for LA! Good
- variance is smaller than bias. But SD is larger. If SD matters, maybe bias does not matter so much

\subsection{2.}

\todo[inline]{write some text!!}
...
```
- this is basicly the same. That is because the variance of the epsilons are so much larger than the variance of the estimators. Compare 
